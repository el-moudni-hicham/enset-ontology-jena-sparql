...
public class EnsetOntology {

    static final String inputFileName = "enset-ontology.rdf";
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!(input.equals("D"))) {
            ...
            if (input.equals("A")) {
                ...
                //display all departements names
            ...
            if (input.equals("B")) {
                ...
                //write data to file
                try{
                    OutputStream output = new FileOutputStream("search-departement-result.rdf");
